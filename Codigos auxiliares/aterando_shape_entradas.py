...
def criar_modelo():
    modelo = Sequential([
    Conv2D(32, (3, 3), activation='relu', kernel_regularizer=l2(0.1), input_shape=(90, 3, 1)),
    Reshape((90 - 2, 32)),
...
X_1 = preprocessar_sinal_RGB(caminho_100001)[:308]
X_2 = preprocessar_sinal_RGB(caminho_100002)[:308]
X_3 = preprocessar_sinal_RGB(caminho_100003)[:308]
X_4 = preprocessar_sinal_RGB(caminho_100004)[:308]
X_5 = preprocessar_sinal_RGB(caminho_100005)[:308]

X = np.stack([X_1, X_2, X_3, X_4, X_5])

y_1 = saturacoes(caminho_saturacao_100001, X_1)[:308]
y_2 = saturacoes(caminho_saturacao_100002, X_2)[:308]
y_3 = saturacoes(caminho_saturacao_100003, X_3)[:308]
y_4 = saturacoes(caminho_saturacao_100004, X_4)[:308]
y_5 = saturacoes(caminho_saturacao_100005, X_5)[:308]

y = np.stack([y_1, y_2, y_3, y_4, y_5])
