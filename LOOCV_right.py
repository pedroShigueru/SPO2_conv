...
caminho_100001 = r"D:\usuarios\pedro.watanabe\Meus Documentos\Projetos\RedeNeural\Experiments\Atividade 22\ppg_csv\Right\100001.csv"
caminho_100002 = r"D:\usuarios\pedro.watanabe\Meus Documentos\Projetos\RedeNeural\Experiments\Atividade 22\ppg_csv\Right\100002.csv"
caminho_100003 = r"D:\usuarios\pedro.watanabe\Meus Documentos\Projetos\RedeNeural\Experiments\Atividade 22\ppg_csv\Right\100003.csv"
caminho_100004 = r"D:\usuarios\pedro.watanabe\Meus Documentos\Projetos\RedeNeural\Experiments\Atividade 22\ppg_csv\Right\100004.csv"
caminho_100005 = r"D:\usuarios\pedro.watanabe\Meus Documentos\Projetos\RedeNeural\Experiments\Atividade 22\ppg_csv\Right\100005.csv"
#caminho_100006 = r"D:\usuarios\pedro.watanabe\Meus Documentos\Projetos\RedeNeural\Experiments\Atividade 22\ppg_csv\Right\100006.csv"
...
for indice in indices:
    ...
    if indice == 3:
        X_train = np.concatenate((X_2, X_1, X_4, X_5), axis=0)
        y_train = np.concatenate((y_2, y_1, y_4, y_5), axis=0)

        X_test = X_3
        y_test = y_3

    if indice == 4:
        X_train = np.concatenate((X_2, X_3, X_1, X_5), axis=0)
        y_train = np.concatenate((y_2, y_3, y_1, y_5), axis=0)

        X_test = X_4
        y_test = y_4

    if indice == 5:
        X_train = np.concatenate((X_2, X_3, X_4, X_1), axis=0)
        y_train = np.concatenate((y_2, y_3, y_4, y_1), axis=0)
